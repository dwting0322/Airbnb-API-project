...
![AirBnB](https://user-images.githubusercontent.com/101853690/181394156-ad353c4f-5a22-43db-a3ee-00a62538094e.png)
...
* Request
  * Method: POST
  * URL: /api/users/login/credential
  * Headers:
    * Content-Type: application/json
  * Body:
